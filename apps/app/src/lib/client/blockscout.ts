...
export const getExplorerUrl = (
  ...
  // HashScan uses /transaction/ instead of /tx/ and /account/ instead of /address/
  if (baseUrl.includes('hashscan.io')) {
    return type === 'address'
...
export const getExplorerName = (network: UnifiedNetwork): string => {
  ...
  if (explorerUrl.includes('hashscan')) {
    return explorerUrl.includes('testnet') ? 'HashScan Testnet' : 'HashScan'
  }
