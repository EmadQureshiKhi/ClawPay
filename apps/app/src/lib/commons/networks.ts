/**
 * Unified Network Registry for ClawPay
 * 
 * This module serves as the single source of truth for all network configurations,
 * token addresses, and blockchain metadata across ClawPay. It consolidates data from
  ...
  'hedera-testnet': {
    ...
    tokens: {
      'hbar': {
        ...
        logoUri: '/logos/hedera-icon.svg',
        verified: true,
        verificationSource: 'Hedera',
      },
      'usdc': {
        symbol: 'USDC',
        name: 'USD Coin',
        decimals: 6,
        address: '0x0000000000000000000000000000000000001549' as Address,
        isNative: false,
        isStablecoin: true,
        coingeckoId: 'usd-coin',
        logoUri: '/tokens/usdc.svg',
        verified: true,
        verificationSource: 'Hedera Token Service',
      },
    },
  },
  ...
  'hedera': {
    ...
    tokens: {
      ...
      'usdc': {
        ...
        name: 'USD Coin',
        decimals: 6,
        address: '0x000000000000000000000000000000000006f89a' as Address,
        isNative: false,
        isStablecoin: true,
        coingeckoId: 'usd-coin',
        logoUri: '/tokens/usdc.svg',
