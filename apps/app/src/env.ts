...
const clientEnvSchema = z.object({
  ...
  NEXT_PUBLIC_API2_URL: z.string().url().optional(),
});
...
const rawClientEnv = {
  ...
  NEXT_PUBLIC_MCP2_URL: process.env.NEXT_PUBLIC_MCP2_URL ?? 'https://mcp2.clawpay.tech',
  NEXT_PUBLIC_MCP_PROXY_URL: process.env.NEXT_PUBLIC_MCP_PROXY_URL ?? 'https://mcp.clawpay.tech',
  NEXT_PUBLIC_MCP_DATA_URL: process.env.NEXT_PUBLIC_MCP_DATA_URL ?? 'https://data.clawpay.tech',
  NEXT_PUBLIC_API2_URL: process.env.NEXT_PUBLIC_API2_URL ?? 'https://api2.clawpay.tech',
};
