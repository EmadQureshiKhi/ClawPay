      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <StatsCard label="TRANSACTIONS" value={stats.totalTransactions.toLocaleString()} />
            <StatsCard label="VOLUME" value={`$${stats.totalVolumeUsd.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`} />
