        ...
        <div className="space-y-4 overflow-y-auto max-h-[calc(90vh-120px)]">
          ...
          {!session?.user ? (
            ...
            <div className="space-y-4">
              ...
              <div className={`p-3 rounded-md border ${isDark ? "bg-gray-800/50 border-gray-700" : "bg-blue-50 border-blue-200"}`}>
                <div className="flex items-start gap-3">
                  <div className={`p-2 rounded-md ${isDark ? "bg-gray-700/50 text-gray-400" : "bg-blue-500/10 text-blue-600"}`}>
                    <AlertTriangle className="h-4 w-4" />
                  </div>
                  <div className="space-y-1">
