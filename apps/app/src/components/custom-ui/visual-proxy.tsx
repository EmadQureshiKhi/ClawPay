...
export default function VisualProxy({
  ...
  const clawpayRef = useRef<HTMLDivElement>(null)
  ...
  return (
    ...
    >
      <div className="inline-flex">
        <HighlighterText className="!text-foreground">CLAWPAY PROXY</HighlighterText>
      </div>
          ...
          <TooltipProvider>
            ...
            <div className="flex flex-col justify-center relative z-20">
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="relative z-20">
                    <Square ref={clawpayRef}>
                      <div
                        className="bg-teal-700 dark:bg-teal-200"
                        style={{
                          width: "52px",
                          height: "52px",
                          maskImage: "url(/clawpay-logo.png)",
                          maskSize: "contain",
                          maskRepeat: "no-repeat",
                          maskPosition: "center",
                          WebkitMaskImage: "url(/clawpay-logo.png)",
                ...
                <TooltipContent>
                  <p>ClawPay Proxy: we handle x402 payments on Hedera, you just get paid.</p>
                </TooltipContent>
              </Tooltip>
            </div>
          </TooltipProvider>
      ...
      <div className="flex flex-col lg:flex-row lg:items-center gap-6 lg:gap-12">
        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:max-w-[50%] lg:flex-1">
          ...
          <Link href="https://github.com/EmadQureshiKhi/ClawPay" target="_blank" rel="noopener noreferrer" className="w-full lg:w-auto lg:flex-1">
