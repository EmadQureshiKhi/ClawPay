      ...
      sections: [
        {
          ...
          content: [
            ...
            },
            {
              ...
              description: 'Alternative method using wallet private key. Replace YOUR_PRIVATE_KEY with your actual Hedera EVM private key.',
              language: 'json',
              copyable: true,
              badge: 'Alternative',
              code: JSON.stringify({
            ...
            {
              type: 'code',
              title: 'ClawPay CLI (Direct Connection)',
              description: 'Use API key for authentication (recommended) or Hedera private key as alternative',
              language: 'bash',
              copyable: true,
              code: `# Using API Key (recommended)
npx @clawpay-hedera/sdk server --urls ${urlUtils.getMcpUrl(serverData.serverId)} --api-key clawpay_YOUR_API_KEY_HERE

# Using Hedera Private Key (alternative)
npx @clawpay-hedera/sdk server --urls ${urlUtils.getMcpUrl(serverData.serverId)} --hedera-key YOUR_HEDERA_PRIVATE_KEY`
            }
          ]
        },
        {
...
import { createPaymentTransport } from '@clawpay-hedera/sdk/client'
import { privateKeyToAccount } from 'viem/accounts'

// Initialize account from Hedera EVM private key
const account = privateKeyToAccount('0xYOUR_HEDERA_PRIVATE_KEY')
const url = new URL('${urlUtils.getMcpUrl(serverData.serverId)}')

// Create payment-enabled transport (Hedera x402)
...
const client = new Client(
  { name: 'my-clawpay-client', version: '1.0.0' },
  { capabilities: {} }
)
...
console.log('Available tools:', tools)`
      ...
      securityWarning: {
        ...
        message: 'Never share your private key publicly or in version control. The ClawPay proxy handles payments securely using your private key locally. Consider using environment variables or secure key management solutions in production.'
      },
      quickLinks: [
        {
          text: 'View Tools',
        ...
        {
          text: 'ClawPay GitHub',
          href: 'https://github.com/EmadQureshiKhi/ClawPay',
          variant: 'secondary',
          icon: Github
        },
        {
