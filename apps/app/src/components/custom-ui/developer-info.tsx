      ...
      <div className="flex flex-col gap-12">
        ...
        <div className="flex flex-col gap-6">
          ...
          <InfoCard
            ...
            ctaText="SOURCE CODE"
            ctaHref="https://github.com/EmadQureshiKhi/ClawPay"
          />
          <InfoCard
            icon={ShieldCheck}
            label="NON INTRUSIVE"
          ...
          <InfoCard
            ...
            copy={
              <>
                Built on Hedera with native HTS USDC payments{" "}
                <span className="text-muted-foreground">and HCS audit trails for every transaction.</span>
              </>
            }
          />
          </div>
