...
export const metadata: Metadata = {
  ...
  title: "ClawPay: AI agent payments on Hedera",
  description: "The payment layer for AI agents on Hedera. Autonomous x402 micropayments using native HTS USDC, HBAR, and HCS audit trails.",
  icons: {
    icon: [
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'ClawPay: AI agent payments on Hedera',
      }
    ],
  },
  twitter: {
