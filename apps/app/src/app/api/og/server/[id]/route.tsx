...
export async function GET(
  ...
  try {
    ...
    const baseUrl = process.env.NEXT_PUBLIC_BASE_URL || 'https://clawpay.tech';
    const backgroundImageUrl = `${baseUrl}/Clawpay_OG.png`;
          ...
          <div style={{ marginTop: "auto", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              <div style={{ display: "flex", gap: 12, alignItems: "center", opacity: 0.85, fontSize: 17 }}>
                ...
                />
                <div style={{ fontWeight: 500, display: "block" }}>ClawPay: AI agent payments on Hedera</div>
              </div>
              <div style={{ fontSize: 15, opacity: 0.55, paddingLeft: 22, display: "block" }}>clawpay.tech</div>
            </div>
            <div
              style={{
                width: 96,
