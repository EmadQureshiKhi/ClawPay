...
This directory contains hooks that can be used with the ClawPay proxy system to modify requests and responses.
...
All hooks implement the `Hook` interface from `@clawpay-hedera/sdk/handler`:
